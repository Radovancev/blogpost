...
namespace site_priprema.Areas.Admin.Controllers
{
    ...
    {
        private VlogEntities db = new VlogEntities();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PostID,Post1,Text,Created_At,Updated_At,CategoryID,UserID,Path")] Post post)
        {
            if (ModelState.IsValid)
            {
